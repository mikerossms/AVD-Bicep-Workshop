...
$domainAdminUsername = "<insert fully qualified account that can be used to join domain here>"
$domainOUPath = "<insert OU here>"
...
$adServerIPAddresses = @(
  "<Insert ADDS or AADDS DNS servers here>"
)

#Set up some basic tags to attach to resources
$tags = @{
    Environment=$localEnv
    Owner="<insert owner name here>"
}
